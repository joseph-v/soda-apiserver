...
import (
	...
	"github.com/opensds/soda-apiserver/pkg/api/controllers"
...
func init() {
	...
	filens :=
		...
		beego.NewNamespace("/"+constants.APIVersion+"/:tenantId/file",
			beego.NSRouter("/shares", &controllers.FileSharePortal{}, "post:CreateFileShare;get:ListFileShares"),
			beego.NSRouter("/shares/:fileshareId", &controllers.FileSharePortal{}, "get:GetFileShare;put:UpdateFileShare;delete:DeleteFileShare"),
