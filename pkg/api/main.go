...
import (
	...
	"github.com/opensds/soda-apiserver/pkg/api/filter/accesslog"
	"github.com/opensds/soda-apiserver/pkg/api/filter/auth"
	"github.com/opensds/soda-apiserver/pkg/api/filter/context"
	"github.com/opensds/soda-apiserver/pkg/api/filter/validation"
	cfg "github.com/opensds/soda-apiserver/pkg/utils/config"
	"github.com/opensds/soda-apiserver/pkg/utils/constants"

	// Load the API routers
	_ "github.com/opensds/soda-apiserver/pkg/api/routers"
)
